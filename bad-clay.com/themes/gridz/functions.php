...
function gridz_footer_credit() {
    $output = '';
    $output .= __(' &copy; 2014 BAĐ CLAY STUDIO - 3D / CGI / VFX / Zbrush / Concept Art Studio','gridz');
    echo $output;
}
...
function gridz_continue_reading_link() {
    return '<a class="more-link" href="'.get_permalink().'">'.__('View more >>','gridz').'</a>';
}
...
function my_custom_post_product() {
  ...
  $args = array(
    'labels'        => $labels,
    'description'   => 'Holds our blog and blog specific data',
    'public'        => true,
    'menu_position' => 5,
